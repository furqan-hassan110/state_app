...
import {fetchAllUser, subscribeUser} from '../../utils/apiUtils';
...
const AgentLovedScreen = ({navigation}) => {
  ...
  const handleApprove = user => {
    ...
    subscribeUser(user.id, userToken)
      .then(res => {
        console.log('RES ==> ', res);
        fetchAllUser(userToken)
          .then(response => {
  ...
  const filteredUsers = allUsers.filter(
    user => user.subscriptionStauts === filter,
  );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        <TouchableOpacity
          style={[
            styles.filterButton,
            filter === 'requested' && styles.activeFilter,
          ]}
          onPress={() => setFilter('requested')}>
          <Text
            style={[
              styles.filterText,
              filter === 'requested' && styles.activefiltertext,
            ]}>
            Requested
          </Text>
        </TouchableOpacity>
